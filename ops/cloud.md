...
- Replace entire instances or containers with new versions containing the updates (e.g., Docker containers, AMI rebuilds).
- Treat servers as cattle, not pets.

### 3. Principle of Least Privilege
- IAM roles, service accounts, and database credentials should only grant the exact permissions needed for the specific task.
