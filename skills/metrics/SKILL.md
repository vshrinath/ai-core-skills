...
Load `skills/metrics/references/template.md` and populate it. Write the completed file to `.project/metrics.md`. Confirm to the user before handing off to `@arch` or `@dev`.
